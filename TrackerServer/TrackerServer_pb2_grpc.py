...
class TrackerServerServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AskFileOperation = channel.unary_unary(
                '/TrackerServerService/AskFileOperation',
        ...
        self.UpdateFileInfo = channel.unary_unary(
                '/TrackerServerService/UpdateFileInfo',
        ...
        self.Replicate = channel.unary_unary(
                '/TrackerServerService/Replicate',
        ...
        self.AddStorageServer = channel.unary_unary(
                '/TrackerServerService/AddStorageServer',
...
def add_TrackerServerServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'TrackerServerService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class TrackerServerService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def GetFileList(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/TrackerServerService/GetFileList',
    ...
    def UpdateFileInfo(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/TrackerServerService/UpdateFileInfo',
    ...
    def Replicate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/TrackerServerService/Replicate',
